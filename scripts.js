(function () {
  ...
  var docsPages = [
    ...
    { url: 'presets.html', title: 'Presets', summary: 'Compare Revon, Quiet Form, and Joinery typography, colors, spacing, templates, and homepage sections.' },
    ...
    { url: 'badges.html', title: 'Product badges', summary: 'Create custom product-card badges with tags, bulk edit values, control colors and priority, and troubleshoot badge display.' },
...
/* Landing wow v2 — hero stat count-up + scroll progress bar. */
(function () {
  'use strict';
  ...
  (function () {
    ...
    var values = document.querySelectorAll('.hero__meta-value');
    if (!meta || !values.length || reduceMotion || !('IntersectionObserver' in window)) return;
  ...
  /* Thin ink progress bar along the very top of the page. */
  (function () {
