...
├── presets.html           Revon / Quiet Form / Joinery preset reference
...
- **Fonts**: the body font is the `--font-body` variable at the top of `styles.css`; each preset's heading font is hardcoded per class (e.g. `.h2--quiet-form`, `.font-sample--joinery`) further down the file
